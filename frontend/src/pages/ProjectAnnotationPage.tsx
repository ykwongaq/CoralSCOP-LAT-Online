...
import {
    AnnotationSessionContext,
    useAnnotationSession,
} from "../features/AnnotationSession/context";
import {
...
function ProjectAnnotationPage() {
    ...
    const { showMessage, closeMessage, showLoading, showError } =
        usePopMessage();
                        ...
                        <div className="main">
                            <SideBar>
                                ...
                                <SideBarButton
                                    ...
                                    isActive={
                                        projectLoaded &&
                                        activePanel === ImageGalleryPanelID
                                    }
                                ...
                                <SideBarButton
                                    ...
                                    label="Annotations"
                                    onClick={() =>
                                        handlePanelChange(AnnotationPanelID)
                                    }
                                    isActive={
                                        projectLoaded &&
                                        activePanel === AnnotationPanelID
                                ...
                                <SideBarButton
                                    ...
                                    label="Statistics"
                                    onClick={() =>
                                        handlePanelChange(StatisticPanelID)
                                    }
                                    isActive={
                                        projectLoaded &&
                                        activePanel === StatisticPanelID
                                ...
                                >
                                    ...
                                    <SideBarDropDownButton
                                        ...
                                        onClick={async () => {
                                            ...
                                            try {
                                                await exportAllCocoAnnotations(
                                                    state,
                                                );
                                            } catch (error) {
                                                showError({
